...
public abstract class Interaccion {
     ...
     */
    public abstract void cargarItemAReconocer(Dificultad dificultad, MiniJuegoActivity miniJuegoActivity);

    /*
        Propósito: carga el item (palabra o imagen) ganador ubicado en la parte inferior segun la dificultad definida
     */
    public abstract void cargarItemGanador(Dificultad dificultad, MiniJuegoActivity miniJuegoActivity);
